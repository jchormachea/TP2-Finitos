function [stiffnessMatrix]=assembleStiffnessMatrix(elementType,elementNodesArray,nodesPositionArray,constitutiveMatrix,t)
...
switch elementType
    ...
    case 'Q8'
        nDimensions = 2;                                %Problem dimension
        nGaussPoints = 9;%lo normal es 4 pero Nx usa 9
        elementShape='Quadrilateral';
    case 'Q9'
        nDimensions = 2;                                %Problem dimension
        nGaussPoints = 9;%lo normal es 9
        elementShape='Quadrilateral';
end
...
for iElement = 1:nElements
    ...
    for iGaussPoint = 1:nGaussPoints
        ...
        elementalStiffnessMatrix = elementalStiffnessMatrix + t*B'*constitutiveMatrix*B*gaussPointsWeight(iGaussPoint)*jacobianDeterminant;
    end
